...
const _appFeatured = [
  {
    id: 1,
    title: 'Importing PDF Plans',
    description: 'Learn how to calibrate, trace, and manage multiple plan sheets',
    image: '/images/featured_01.jpg',
  },
  {
    id: 2,
    title: 'Calculate Takeoff Data',
    description: 'Add doors, windows, and other openings to get accurate results',
    image: '/images/featured_02.jpg',
  },
  {
    id: 3,
    title: 'Realtime Virtual Showroom',
    description: 'Select fixtures and appliances from around the world',
    image: '/images/featured_03.jpg',
  },
];
