...
const onRedirectCallback = (appState: any) => {
  console.log('vh-state', appState);
  Router.replace(appState?.targetUrl || '/dashboard');
};
            ...
            <LocalizationProvider dateAdapter={AdapterDateFns}>
              <CollapseDrawerProvider>
                <SettingsProvider defaultSettings={settings}>
                  <ThemeProvider>
                    <Fullscreen
                      enabled={screenState.fullscreen}
                      onChange={(e) => screenActions.set(e)}
                    >
                      <NotistackProvider>
                        <MotionLazyContainer>
                          <ThemeColorPresets>
                            <ThemeLocalization>
                              <RtlLayout>
                                ...
                                {/* <Settings /> */}
                                <ProgressBar />
                                {screenState.loading && <LoadingPureWeb />}
